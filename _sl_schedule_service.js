    ...
    function(ui, email, runtime, search, record, http, log, redirect, task) {
        ...
        function scheduleRun(context){
            if (context.request.method === 'GET') {
                ...
                var custRecord = record.load({type: 'customer', id: customer_id});
                ...
                var customerAddressSearch = search.load({ type: 'customer', id: 'customsearch_smc_address'});
                ...
                // var newFilters1 = new nlobjSearchFilter('internalid', 'custrecord_service_leg_service', 'is', service_id);
                search.createFilter({
                    name: 'internalid',
                ...
                // var newFilters2 = new nlobjSearchFilter('isinactive', null, 'is', 'F');
                search.createFilter({
                    name: 'isinactive',
                    join: 'null',
                    operator: search.Operator.IS,
                ...
                serviceLegSearch.filters.push(newFilters1);
                serviceLegSearch.filters.push(newFilters2);
                ...
                resultSet.each(function(searchResult) {
                    ...
                    log.debug({
                        title: 'transfer_app_service_leg_n',
                    ...
                    if (freq_length == 1) { //same time everyday
                        ...
                        if (!isNullorEmpty(obj['stop_ncl_id']) || !isNullorEmpty(obj['stop_addr_id'])) {
                            ...
                            if (!isNullorEmpty(obj['stop_ncl_id'])) {
                                var newFiltersTime1 = search.createFilter({
                            ...
                            if (!isNullorEmpty(obj['stop_addr_id'])) {
                                var newFiltersTime2 = search.createFilter({
                            ...
                            serviceLegTimeSearch.filters.push(newFiltersTime1);
                            serviceLegTimeSearch.filters.push(newFiltersTime2);
                        ...
                        if (!isNullorEmpty(obj['stop_ncl_id']) || !isNullorEmpty(obj['stop_addr_id'])) {
                            ...
                            if (!isNullorEmpty(obj['stop_ncl_id'])) {
                                var newFiltersTimeWindow1 = search.createFilter({
                                    name: 'custrecord_service_leg_non_cust_location',
                                    join: null,
                                    operator: search.Operator.IS,
                                    values: obj['stop_ncl_id']
                            ...
                            if (!isNullorEmpty(obj['stop_addr_id'])) {
                                var newFiltersTimeWindow2 = search.createFilter({
                                    name: 'custrecord_service_leg_addr',
                                    join: null,
                                    operator: search.Operator.IS,
                                    values: obj['stop_addr_id']
                            ...
                            serviceLegTimeWindowSearch.filters.push(newFiltersTimeWindow1);
                            serviceLegTimeWindowSearch.filters.push(newFiltersTimeWindow2);
