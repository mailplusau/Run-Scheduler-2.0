    ...
    function(error, runtime, search, url, record, format, email, currentRecord) {
        ...
        function startJQuery(){
            ...
            $(document).on('click', '#create_new', function(e) {
                ...
                var custVal = currRecord.getValue({
                    fieldId: 'custpage_customer_id'
                });
                var params = {
                    custid: parseInt(custVal),
        ...
        function onclick_back() {
            var currRecord = currentRecord.get();
            var suiteVal = currRecord.getValue({
                fieldId: 'custpage_suitlet'
            });
            var deployVal = currRecord.getValue({
            ...
            params = JSON.stringify(params);
            console.log(suiteVal);
            console.log(deployVal);

            var output = redirect.toSuitelet({
                scriptId: suiteVal,
                deploymentId: deployVal,
                isExternal: true,
            });
        ...
        function saveRecord() {
            var currRecVal = currentRecord.get();
            var zeePageVal = currRecVal.getValue({
                fieldId: 'custpage_zee',
            });
            zee = parseInt(zeePageVal);
            ...
            var customer_id = currRecVal.getValue({
                fieldId: 'custpage_customer_id',
            });
            
            var service_id = currRecVal.getValue({
            ...
            for (var i = 0; i < edit_stop_elem.length; ++i) {
                ...
                if (delete_stop_elem[i].value == 'T' && !isNullorEmpty(delete_stop_id)) {
                    ...
                    var deleted_link_zee = service_leg_record.getValue({ fieldId: 'custrecord_service_leg_trf_franchisee'});
                    ...
                    service_leg_record.setValue({ fieldId: 'isinactive', value: 'T' });
                    ...
                    if (isNullorEmpty(old_stop_id)) {
                        ...
                        service_leg_record.setValue({ fieldId: 'custrecord_service_leg_service', value: service_id });
                    ...
                    service_leg_record.setValue({ fieldId: 'name', value: table_stop_name_elem[i].value });
        
                    service_leg_record.setValue({ fieldId: 'custrecord_service_leg_number', value: (i + 1)});
                    service_leg_record.setValue({ fieldId: 'custrecord_service_leg_location_type', value: table_info_elem[i].getAttribute('data-addresstype')});
                    if (!isNullorEmpty(table_stop_name_elem[i].getAttribute('data-ncl')) && table_stop_name_elem[i].getAttribute('data-ncl') != 0) {
                        service_leg_record.setValue({ fieldId: 'custrecord_service_leg_non_cust_location', value: table_stop_name_elem[i].getAttribute('data-ncl')});
                    }
        
                    if (table_stop_name_elem[i].getAttribute('data-customeraddressid') != 0) {
                        service_leg_record.setValue({ fieldId: 'custrecord_service_leg_addr', value: table_stop_name_elem[i].getAttribute('data-customeraddressid')});
                    }
        
                    service_leg_record.setValue({ fieldId: 'custrecord_service_leg_addr_postal', value: table_stop_name_elem[i].getAttribute('data-postbox')});
                    if (isNullorEmpty(table_stop_name_elem[i].getAttribute('data-postbox'))) {
                        service_leg_record.setValue({ fieldId: 'custrecord_service_leg_addr_subdwelling', value: table_stop_name_elem[i].getAttribute('data-addr1')});
                    }
        
                    if (!isNullorEmpty(transfer_type) && transfer_type != 0) {
                        service_leg_record.setValue({ fieldId: 'custrecord_service_leg_trf_type', value: transfer_type});
                        service_leg_record.setValue({ fieldId: 'custrecord_service_leg_trf_franchisee', value: linked_zee});
                    }
        
                    service_leg_record.setValue({ fieldId: 'custrecord_service_leg_addr_st_num_name', value: table_stop_name_elem[i].getAttribute('data-addr2')});
                    service_leg_record.setValue({ fieldId: 'custrecord_service_leg_addr_suburb', value: table_stop_name_elem[i].getAttribute('data-city')});
                    service_leg_record.setValue({ fieldId: 'custrecord_service_leg_addr_state', value: table_stop_name_elem[i].getAttribute('data-state')});
                    service_leg_record.setValue({ fieldId: 'custrecord_service_leg_addr_postcode', value: table_stop_name_elem[i].getAttribute('data-zip')});
                    service_leg_record.setValue({ fieldId: 'custrecord_service_leg_addr_lat', value: table_stop_name_elem[i].getAttribute('data-lat')});
                    service_leg_record.setValue({ fieldId: 'custrecord_service_leg_addr_lon', value: table_stop_name_elem[i].getAttribute('data-lng')});
                    ...
                    service_leg_record.setValue({ fieldId: 'custrecord_service_leg_notes', value: notes});
                        ...
                        if (table_stop_name_elem[i].hasAttribute('data-storedzee')) {
                            ...
                            if (stored_zee != linked_zee) {
                                ...
                                serviceLegSearch.filters.push(search.createFilter({
                                    name: 'custrecord_service_freq_stop',
                                    operator: search.Operator.IS,
                                    values: original_service_leg_id
                                }));

                                serviceLegSearch.filters.push(search.createFilter({
                                    name: 'custrecord_service_freq_franchisee',
                                    operator: search.Operator.IS,
                                    values: stored_zee
                                }));
                            ...
                            var freq_record_owner = record.create({
                                type: 'customrecord_service_freq',
                            });
                            
                            freq_record_owner.setValue({ fieldId: 'custrecord_service_freq_franchisee', value: zee });
                            freq_record_owner.setValue({ fieldId: 'custrecord_service_freq_customer', value: customer_id });
                            freq_record_owner.setValue({ fieldId: 'custrecord_service_freq_service', value: service_id });
                            freq_record_owner.setValue({ fieldId: 'custrecord_service_freq_stop', value: original_service_leg_id });
                            
                            freq_record_owner.save({
                                enableSourcing: true,
                            });
            ...
            currRecVal.setValue({ fieldId: 'custpage_freq_edited', value: freq_edited_string });
            currRecVal.setValue({ fieldId: 'custpage_stored_zee', value: stored_string});
            currRecVal.setValue({ fieldId: 'custpage_linked_zee', value: linked_string});
            currRecVal.setValue({ fieldId: 'custpage_freq_created', value: freq_created_string});
            currRecVal.setValue({ fieldId: 'custpage_freq_created_zees', value: created_linked_zee_string});
            currRecVal.setValue({ fieldId: 'custpage_deleted_stop', value: deleted_stop_string});
            currRecVal.setValue({ fieldId: 'custpage_deleted_linked_zee', value: deleted_linked_zee_string});
            currRecVal.setValue({ fieldId: 'custpage_updated_stop', value: updated_stop_string });
            currRecVal.setValue({ fieldId: 'custpage_old_stop', value: old_stop_string});
            currRecVal.setValue({ fieldId: 'custpage_updated_stop_zee', value: updated_stop_zee_string});
            currRecVal.setValue({ fieldId: 'new_service_leg_id_string', value: new_service_leg_id_string});
